...
export default function HomePageClient() {
  ...
  }, [currentUser, loading, minLoadTimePassed, navigate])

  const handleGetStarted = () => navigate("/buy-data")
            ...
            >
              <div className="relative w-full max-w-[280px] sm:max-w-sm md:max-w-md lg:max-w-lg mx-auto">
                <img
                  ...
                  width={400}
                  height={400}
                  className="w-full h-auto rounded-3xl object-cover drop-shadow-2xl mix-blend-multiply dark:mix-blend-lighten hover:scale-105 transition-transform duration-500"
                />
                {/* Decorative elements behind image */}
                <div className="absolute -z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-gradient-to-tr from-blue-500/20 to-purple-500/20 rounded-full blur-3xl" />
              </div>
            </motion.div>
          </section>
        </main>
                ...
                <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <Card className="border border-blue-200 dark:border-blue-800 backdrop-blur-md">
                    <CardContent className="p-4 sm:p-6">
                      ...
                      <Button
                        onClick={() => navigate("/signup")}
                        className="w-full mt-4 sm:mt-6 bg-blue-600 hover:bg-blue-700 text-base text-white rounded-full text-sm sm:text-base py-2 sm:py-3"
                      >
