...
const fetcher = (url: string): Promise<AdminStatsResponse> => fetch(url).then((res) => res.json())
...
export default function AdminDashboard() {
  const { data: stats, error, isLoading } = useSWR<AdminStatsResponse>('/api/admin/stats', fetcher, {
