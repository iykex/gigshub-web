          ...
          <DropdownMenu>
            ...
            >
              <DropdownMenuItem asChild className="rounded-xl text-xs md:text-sm">
                <Link to="/tutorials/how-to-buy-data" className="text-blue-600">How to Buy Data</Link>
              </DropdownMenuItem>
              <DropdownMenuItem asChild className="rounded-xl text-xs md:text-sm">
                <Link to="/tutorials/how-to-make-payments" className="text-blue-600">How to Make Payments</Link>
              </DropdownMenuItem>
              <DropdownMenuItem asChild className="rounded-xl text-xs md:text-sm">
                <Link to="/tutorials/how-to-topup-wallet" className="text-blue-600">How to Top Up Wallet</Link>
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
